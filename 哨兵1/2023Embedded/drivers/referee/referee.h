...
typedef enum
{
	...
	LEN_game_robot_survivors       		=  28,	//0x0003  比赛机器人血量数据
	...
	LEN_game_robot_state    			= 15,	//0x0201机器人状态数据
	LEN_power_heat_data   				= 14,	//0x0202实时功率热量数据
...
/*******************************机器人交互 哨兵用不上**********************************/
void Client_graphic_Init(void);                         //绘制字符串
